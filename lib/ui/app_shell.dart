...
class _AppShellState extends ConsumerState<AppShell> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final expectedDestination = _destinationIdForPermission(
          tabs[selectedIndex].permission,
        );
        ...
        // The license notice renders above the active tab on every layout —
        // a quiet countdown while armed, escalating to amber then red as the
        // deadline closes in. No-op when unarmed.
  ...
  List<AppTab> _getTabsForRole(UserRole role) {
    ...
    final moreEntries = MoreEntry.accessibleFor(authNotifier.hasPermission);
  ...
  void _updateCurrentDestination() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final destinationId = _destinationIdForPermission(
        tabs[_selectedIndex].permission,
      );
