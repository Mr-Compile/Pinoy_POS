...
**Tech Stack:** Flutter 3 / Dart, `flutter_riverpod`, `sqflite`/`sqflite_common_ffi`, `pdf`, `excel`, `file_picker`, `intl`.
...
**Steps:**
1. Move all PDF/Excel generation from `ReportsScreen` into `ReportExportService`.
